...
- [SysResEval](https://github.com/sysreseval/sysreseval): An open-source software suite for teaching and managing exercise sessions and evaluations in network and system administration courses. Students work through guided exercises in a GUI; instructors monitor sessions and run time-limited exams with automatic, reproducible grading.
